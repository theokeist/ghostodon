...
export const STAGES: Stage[] = [
  ...
  { id: 11, title: 'Explore (trends)', status: 'todo' },
  { id: 12, title: 'Profile viewer', status: 'done' },
  { id: 13, title: 'Followers / Following lists', status: 'todo' },
  { id: 14, title: 'Lists (create/edit + timeline)', status: 'todo' },
  ...
  { id: 23, title: 'Settings: General', status: 'wip' },
  { id: 24, title: 'Settings: Timeline', status: 'todo' },
  { id: 25, title: 'Settings: Accounts', status: 'todo' },
